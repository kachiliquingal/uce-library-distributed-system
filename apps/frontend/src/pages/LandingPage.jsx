      ...
      <div className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-50 border border-blue-100 text-blue-700 text-sm font-medium mb-8 animate-fade-in-up">
            ...
            <span>Conectando las 21 facultades de la Universidad</span>
          </div>
      ...
      <div className="py-24 bg-white relative z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-gray-500 max-w-2xl mx-auto">Nuestra arquitectura de microservicios garantiza un rendimiento excepcional para miles de estudiantes simultáneamente.</p>
          </div>
